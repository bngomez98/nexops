...
-- profiles, properties, service_requests, jobs, invoices,
-- payments, documents, messages, notifications, and more —
-- with Row Level Security policies and triggers.
--
...
--   • Enable UUID extension (handled below)
