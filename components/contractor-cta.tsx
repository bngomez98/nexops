...
const benefits = [
  {
    ...
    description: "The instant you claim a request, it's removed from every other contractor's dashboard — permanently. You're the only contractor the homeowner hears from. No competing bids, no wasted site visits against someone undercutting you.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  {
    icon: FileText,
    title: "Full project details before you commit",
    description: "Every request includes photos, a written scope, and the homeowner's budget ceiling. You review the complete picture before claiming — so you only take jobs that make sense for your business.",
  ...
  },
  {
    ...
    description: "Starting at $299/month with no per-lead charges, no setup fees, and no long-term commitment. Your membership covers unlimited claims across every trade category you're approved for.",
  ...
  {
    icon: BarChart3,
    title: "Reputation based on documented outcomes",
    description: "Your standing in the network reflects actual project performance. Consistent, high-quality work earns priority notifications and access to higher-value projects. The standard protects contractors who meet it.",
