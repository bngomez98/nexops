      ...
      >
        ...
        <div className="px-3 pb-3">
          {role === 'homeowner' && (
            <Link
              ...
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 w-full rounded-lg bg-sidebar-primary text-sidebar-primary-foreground px-3 py-2.5 text-sm font-semibold transition-all hover:opacity-90 shadow-sm shadow-sidebar-primary/20"
            >
          ...
          {role === 'contractor' && (
            <Link
              href="/dashboard/contractor/available-work"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 w-full rounded-lg bg-sidebar-primary text-sidebar-primary-foreground px-3 py-2.5 text-sm font-semibold transition-all hover:opacity-90 shadow-sm shadow-sidebar-primary/20"
            >
          ...
          {role === 'property-manager' && (
            <Link
              href="/dashboard/property-manager/requests/new"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 w-full rounded-lg bg-sidebar-primary text-sidebar-primary-foreground px-3 py-2.5 text-sm font-semibold transition-all hover:opacity-90 shadow-sm shadow-sidebar-primary/20"
            >
              <PlusCircle className="w-4 h-4" />
        ...
        <nav className="flex-1 overflow-y-auto px-3 pb-4 scrollbar-thin">
          <div className="space-y-5">
                ...
                <div className="space-y-0.5">
                  {group.items.map(item => {
                    ...
                    return (
                      ...
                      >
                        {isActiveItem && (
                          <span className="absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-5 bg-sidebar-primary-foreground/50 rounded-full" />
                        )}
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-sidebar-border bg-sidebar-accent/20 text-[11px] text-sidebar-muted">
              <kbd className="rounded border border-sidebar-border bg-sidebar px-1.5 py-0.5 text-[10px]">⌘</kbd>
              <kbd className="rounded border border-sidebar-border bg-sidebar px-1.5 py-0.5 text-[10px]">K</kbd>
