...
const steps = [
  {
    ...
    description: "Describe the work in plain language, upload 2–10 photos of the site, enter your budget ceiling, and select a few consultation windows. This upfront documentation is what lets the contractor arrive with a real understanding of the job — not to ask basic questions, but to estimate it.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  },
  {
    ...
    description: "Verified contractors in your trade and your part of Topeka are notified as soon as you submit. The first to claim your project locks it — your listing is pulled from every other contractor's view immediately and permanently. No one else contacts you about this job.",
  ...
  },
  {
    ...
    description: "Both you and the contractor receive a confirmed appointment for one of the windows you chose — typically within 24 hours. The contractor reviews your photos, scope, and budget before arriving, so the visit is focused on the estimate, not the discovery.",
  ...
  },
  {
    ...
    description: "After the site visit, the contractor delivers a written, itemized estimate. You decide whether to accept, negotiate, or walk away — no obligation either way. Completed projects are recorded and used to update the contractor's standing in the network.",
