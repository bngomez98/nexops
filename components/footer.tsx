        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex flex-col gap-2">
              <a href="tel:+19139511711" className="inline-flex items-center gap-1.5 text-[12px] text-muted-foreground hover:text-foreground transition-colors">
                <Phone className="h-3 w-3 flex-shrink-0" /> (913) 951-1711
              </a>
              ...
              <span className="inline-flex items-start gap-1.5 text-[12px] text-muted-foreground">
                <MapPin className="h-3 w-3 flex-shrink-0 mt-0.5" /> 405 SW Fillmore St, Topeka, KS 66606
              </span>
            </div>
          </div>
