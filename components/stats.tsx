...
const stats: Stat[] = [
  ...
  { value: 1, suffix: "", label: "Contractor assigned per project request — every time" },
  { prefix: "$", value: 0, suffix: "", label: "Cost to property owners — funded by contractor memberships" },
