...
const roleOptions: { value: Role; label: string; sub: string; icon: React.ElementType }[] = [
  { value: "homeowner",        label: "Property Owner",   sub: "Manage requests for my home or properties",  icon: Home      },
  { value: "property_manager", label: "Property Manager", sub: "Manage multiple properties and portfolios",  icon: Building2 },
  { value: "contractor",       label: "Contractor",       sub: "Receive and work service requests",          icon: Hammer    },
]

const platformFeatures = [
  ["Request portal",      "Submit with photos, scope, and budget. Track status in real time."],
  ["Service history",     "Every project, estimate, and cost — organized by property and trade."],
  ["Maintenance reports", "Periodic summaries with spend breakdown and deferred item flags."],
  ["Advisory dashboard",  "Evidence-based recommendations from your property's actual history."],
  ["Messaging",           "Communicate with your assigned contractor directly in the platform."],
]
        ...
        <div className="space-y-10">
          <div>
            <h2 className="text-[22px] font-bold leading-snug tracking-tight mb-3">
              Complete service management,<br />start to finish.
            </h2>
            <p className="text-[13px] text-muted-foreground leading-[1.85]">
              A Nexus account gives you a persistent, organized record of every request, consultation, estimate, and completed project at your property or portfolio.
            </p>
          </div>

          <div className="space-y-5 text-[12.5px]">
            {platformFeatures.map(([title, desc]) => (
          ...
          <div className="border-t border-border pt-6 grid grid-cols-2 gap-px bg-border">
            {[
              ...
              <div key={label} className="bg-card px-4 py-3">
                ...
                <p className="text-[10.5px] text-muted-foreground uppercase tracking-wide mt-0.5">{label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-[12.5px] text-muted-foreground">Account type</Label>
              <div className="grid gap-2">
                {roleOptions.map(({ value, label, sub, icon: Icon }) => (
                  <button
                    ...
                    className={`flex items-center gap-3 rounded-sm border px-3 py-2.5 text-left transition text-[12.5px] ${
                      form.role === value
            ...
            <div className="space-y-1.5">
              ...
              <Input id="fullName" placeholder="Jane Smith" value={form.fullName}
                ...
                required autoComplete="name" className="text-sm h-9" />
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input id="password" type="password" placeholder="Min. 8 characters" value={form.password}
                  ...
                  required autoComplete="new-password" className="text-sm h-9" />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="confirmPassword" className="text-[12.5px]">Confirm</Label>
