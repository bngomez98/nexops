  ...
  return (
    <LegalShell title="Terms of Service" updated="March 5, 2026">
      ...
      <Section title="2. Platform Description">
        Nexus Operations is a property service coordination platform that connects property owners, homeowners, and property managers with licensed and insured contractors in the Topeka, Kansas metropolitan area. The Platform manages exclusive project assignment — one contractor per submitted request. Nexus Operations is not a contractor, does not perform any work, and is not a party to any agreement between property owners and contractors.
      </Section>
