...
export const metadata: Metadata = {
  ...
  description:
    "Outsourced maintenance coordination for multifamily portfolios with verified contractor response targets.",
}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mb-8">
                NexOps acts as your outsourced maintenance coordination team. We intake requests, route
                verified contractors, enforce backup assignment rules, and provide consolidated billing.
              </p>
              <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 mb-8 max-w-2xl">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground/80 leading-relaxed">
                    <span className="font-semibold text-foreground">Pilot pricing:</span> for the first 30–60 days,
                    property managers pay a flat <span className="font-semibold text-primary">$50–$100 request fee</span>.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-2xl mb-8">
              ...
              <p className="text-muted-foreground">
                Dispatch and arrival targets are based on urgency category, with automatic reassignment when needed.
              </p>
            </div>
        ...
        <section className="py-24 lg:py-28">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-semibold tracking-tight mb-4">Built on verification</h2>
        ...
        <section className="py-20 bg-card/30">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mb-8 text-sm text-muted-foreground">
              <CheckCircle className="h-4 w-4 text-primary" /> Designed for firms managing 100–800 units
            </div>
            <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3.5 text-sm font-semibold bg-primary text-primary-foreground rounded-xl">
              Talk to NexOps
              <ArrowRight className="h-4 w-4" />
