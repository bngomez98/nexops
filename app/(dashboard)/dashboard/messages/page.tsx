...
const mockConversations = [
  {
    ...
    lastMessage: "I'll be there tomorrow at 2 PM. Please make sure the water shutoff is accessible.",
  ...
  },
  {
    ...
    lastMessage: "Thanks for the great review! Let us know if you need anything else.",
    timestamp: "1 day ago",
    unread: true,
  },
  {
    ...
    lastMessage: "The inspection passed. You're all set!",
...
const mockMessages = [
  ...
  },
  {
    id: "6",
    sender: "contractor",
    text: "I'll be there tomorrow at 2 PM. Please make sure the water shutoff is accessible.",
    timestamp: "2 hours ago",
  },
]
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <div className="mb-4">
        ...
        <p className="text-muted-foreground">Communicate with your contractors</p>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden rounded-xl border border-border bg-card">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="font-medium text-sm truncate">{conv.contractor}</span>
                    {conv.unread && (
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-3 border-b border-border p-4">
            ...
            <div>
              <h3 className="font-medium">{selectedConversation.contractor}</h3>
